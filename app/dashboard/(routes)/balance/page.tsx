...
import { Wallet, Plus, History, ArrowUpRight, CreditCard, MessageCircle, Smartphone } from "lucide-react";
import { SUPPORT_PHONE, WHATSAPP_URL } from "@/lib/site";
    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-2xl font-bold text-[#0083d3] mb-2" dir="ltr">{SUPPORT_PHONE}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
            <div className="flex items-start gap-3">
              <div className="p-2 bg-[#0083d3]/10 rounded-full">
                <Smartphone className="h-5 w-5 text-[#0083d3]" />
              </div>
              <div className="flex-1">
                <h3 className="font-semibold text-lg mb-1">إنستاباي</h3>
                <p className="text-2xl font-bold text-[#0083d3] mb-2" dir="ltr">{SUPPORT_PHONE}</p>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            يرجى إرسال صورة إثبات التحويل عبر واتساب
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="p-4 border rounded-lg bg-card">
            <p className="text-sm text-muted-foreground mb-4">
              بعد إتمام عملية التحويل، يرجى إرسال صورة إثبات التحويل إلى نفس الرقم على واتساب:
            </p>
            <div className="flex items-center gap-4">
              <p className="text-xl font-bold text-[#0083d3]" dir="ltr">{SUPPORT_PHONE}</p>
              <Button
                onClick={() => {
