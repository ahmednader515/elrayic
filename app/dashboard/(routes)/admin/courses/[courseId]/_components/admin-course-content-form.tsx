...
import { CourseContentList } from "@/app/dashboard/(routes)/teacher/courses/[courseId]/_components/course-content-list";
...
export const AdminCourseContentForm = ({
    initialData,
    courseId
}: AdminCourseContentFormProps) => {
    ...
    const onEdit = (id: string, type: "chapter" | "quiz") => {
        if (type === "chapter") {
            ...
            router.push(`/dashboard/admin/quizzes/${id}/edit`);
        }
    }
        ...
        <div className="relative mt-6 border bg-card rounded-md p-4">
            ...
            <div className="font-medium flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <Button onClick={() => router.push(`/dashboard/admin/quizzes/create?courseId=${courseId}`)} variant="ghost">
