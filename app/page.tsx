...
import { SITE_DESCRIPTION, SITE_NAME, SITE_SLOGAN, TEACHER_NAME, TEACHER_NAME_AR } from "@/lib/site";
  ...
  return (
      ...
      <section id="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-0 bg-gradient-to-t from-[#0083d3]/25 via-[#0083d3]/10 to-transparent">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-center">
          ...
          >
            <p className="text-lg md:text-xl font-semibold text-[#0083d3] mb-2">
              {SITE_NAME}
            </p>
            ...
            <p className="text-xl md:text-2xl font-medium text-[#0083d3] mb-4">
              {SITE_SLOGAN}
            </p>
      ...
      <section id="courses-section" className="py-20 bg-muted/50">
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground">كورسات للكليات الطبية في مصر والخارج — حكومية وأهلية وخاصة</p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                name: "عصام اسامة",
                grade: "كلية الطب البشري",
                testimonial: `تجربة رائعة مع ${TEACHER_NAME_AR}، شرح مميز وطريقة سهلة في توصيل المعلومة`
              },
              {
                name: "سيف طارق",
                grade: "كلية الصيدلة",
                testimonial: "المنهج منظم جداً والشرح واضح، ساعدني في فهم مواد الكليات الطبية بشكل أفضل"
              },
              {
                name: "عمر جمال",
                grade: "كلية العلاج الطبيعي",
                testimonial: `أفضل منصة للكليات الطبية استخدمتها، المحتوى غني والشرح مبسط على ${SITE_NAME}`
              }
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground">أفضل منصة لكورسات الكليات الطبية في مصر والخارج</p>
            </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">ابدأ رحلتك الطبية معنا</h2>
